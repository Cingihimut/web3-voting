      ...
      <div className="py-10">
        <div className="container mx-auto px-4">
          <div className="max-w-xl mx-auto">
            <h1 class="mb-12 text-2xl text-center font-medium leading-none tracking-tight text-gray-900 md:text-2xl lg:text-4xl dark:text-white">
              <span class="underline underline-offset-8 text-center decoration-4 decoration-blue-400 dark:decoration-blue-600">
                About us
              </span>
            </h1>

            <p class="text-lg mt-4 text-center font-normal text-gray-500 lg:text-xl dark:text-gray-400">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class=" p-4 ">
          <div className=" py-10 px-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 mt-8">
            <div className="container mx-auto px-4">
              <div className="max-w-xl mx-auto">
                <h1 class="mb-8 text-lg text-center font-medium leading-none tracking-tight text-gray-900 md:text-xl lg:text-2xl dark:text-white">
                  <span class="underline underline-offset-8 text-center decoration-4 decoration-blue-400 dark:decoration-blue-600">
                    Our Vision
                  </span>
                </h1>

                <p class="text-md mt-4 text-center font-normal text-gray-500 lg:text-base dark:text-gray-400">
      ...
      <div className="py-10">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 p-4">
              <div class=" p-4">
